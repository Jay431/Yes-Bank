...
//import com.in10s.onevu.CRSPropertyFileReader;
...
public class RASPMSServerclient {
    ...
    public String WaitForJob(String str_JobID) {
		...
		try {
			...
			props.load(Thread.currentThread().getContextClassLoader()
					.getResourceAsStream("CHUB_OTC.properties"));
			String waitingTimeStr = props.getProperty("TIMEOUT");
    ...
    public String GeneratePDF(String RASUserName, String RASPassword, String ATNServerIP, String ATNServerPort,
        ...
        try {
            ...
            objProperties.load(Thread.currentThread().getContextClassLoader().getResourceAsStream("CHUB_OTC.properties"));
